...
Run nextflow
```
$ nextflow run main.nf -profile training --reads="/data/hbionet/test-data/*_R{1,2}.fastq.gz" --trimFor 24 --trimRev 25 --reference="/data/hbionet/ref-data/silva_nr_v132_train_set.fa.gz" --species="/data/hbionet/ref-data/silva_species_assignment_v132.fa.gz" --outdir="$HOME/out"
